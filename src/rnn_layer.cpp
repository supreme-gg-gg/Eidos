...
void RNNLayer::serialize(std::ofstream& toFileStream) const {
...
RNNLayer* RNNLayer::deserialize(std::ifstream& fromFileStream) {
    ...
    RNNLayer* layer = new RNNLayer(weights[0].cols(), weights[0].rows(), weights[2].rows(), nullptr, false);
