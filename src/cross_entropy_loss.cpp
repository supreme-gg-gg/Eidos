...
float CrossEntropyLoss::compute_loss(const Eigen::MatrixXf& predictions, const Eigen::MatrixXf& targets) const {
...
Eigen::MatrixXf CrossEntropyLoss::compute_gradient(const Eigen::MatrixXf& predictions, const Eigen::MatrixXf& targets) const {
