...
public:
     ...
     */
    virtual void load_data(const std::string& filePath, std::vector<T>& features, std::vector<std::string>& labels) = 0;
     ...
     */
    virtual void split_data(const std::vector<T>& features, const std::vector<std::string>& labels, std::vector<T>& train_features, std::vector<std::string>& train_labels, std::vector<T>& test_features, std::vector<std::string>& test_labels, float trainToTestSplitRatio) = 0;
     ...
     */
    virtual void convert_to_one_hot(const std::vector<std::string>& labels, std::vector<Eigen::MatrixXf>& one_hot_labels, const std::map<std::string, int>& mapping) = 0;
};
